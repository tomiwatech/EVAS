...
if (isset($_POST['location']) && isset($_POST['size'])) {
    if (isset($_POST['department']) && isset($_POST['description'])) {
...
$query = "INSERT INTO venue(location,size,department,description) VALUES('$location','$size','$department','$description')";
      ...
      <div class="layout-content">
        <div class="layout-content-body">
          <div class="title-bar">
             ...
             <marquee>Add new venue</marquee></span>
            </h1>
          </div>

            <form style="width: 50%;margin-top:50px;margin-left:250px" method="POST" action="venue.php">
              <div class="form-group">
          
                  <span style="padding-left: 227px">Location</span>
                   <select class="form-control" name="location" required>
                      <option></option>
                      <option>FOOD TECH BUILDING 2A</option>
                      <option>FOOD TECH BUILDING 2B</option>
                      <option>NEW BUILDING 2A</option>
                      <option>NEW BUILDING 2B</option>
                      <option>POLYMER TECHNOLOGY</option>
                      <option>NASB</option>
                    </select>
              </div>
              <div class="form-group">
          <span style="padding-left: 240px">Size</span> 
          <input class="form-control" placeholder="ENTER SIZE" name="size" type="text"  required/>
              </div>
               <div class="form-group">
                 <span style="padding-left: 227px">Department</span> 
                 <input class="form-control" placeholder="ENTER DEPARTMENT" name="department" type="text" required  />
              </div>

              <div class="form-group">
                 <span style="padding-left: 227px">Description</span>
                  <textarea class="form-control" placeholder="ENTER DESCRIPTION HERE" name="description" cols="20" rows="6" required></textarea>
              </div>

             
                    
         <button class="btn btn-primary pull-right" type="submit" style="margin-right: 255px;margin-top: 20px">Add Venue</button>
