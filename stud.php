...
if (isset($_POST['class']) && isset($_POST['surname'])) {
    if (isset($_POST['firstname']) && isset($_POST['lastname'])) {
       if (isset($_POST['matric']) && isset($_POST['phone'])) {
...
$query = "INSERT INTO students(class,surname,firstname,lastname,matric,phone,email) VALUES('$class','$surname','$firstname','$lastname','$matric','$phone','$email')";
    ...
    <div class="layout-main">
      ...
      <div class="layout-content">
        <div class="layout-content-body">
         ...
         <h4 style="text-align: center;padding-right: 85px;">ADD NEW STUDENT RECORD</h4>
            <form style="width: 50%;margin-left:250px" method="POST" action="stud.php">
              <div class="form-group">
          
                  <span style="padding-left: 227px">Class</span>
              ...
              <div class="form-group">
          <span style="padding-left: 225px">Surname</span> 
          <input class="form-control" placeholder="ENTER SURNAME" name="surname" type="text"  required/>
              </div>
               <div class="form-group">
                 <span style="padding-left: 215px">First name</span> 
                 <input class="form-control" placeholder="ENTER FIRSTNAME" name="firstname" type="text" required  />
              </div>

               <div class="form-group">
                 <span style="padding-left: 215px">Last name</span> 
                 <input class="form-control" placeholder="ENTER LASTNAME" name="lastname" type="text" required  />
              </div>

               <div class="form-group">
                 <span style="padding-left: 227px">Matric</span> 
                 <input class="form-control" placeholder="ENTER MATRIC" name="matric" type="text" required  />
              </div>

               <div class="form-group">
                 <span style="padding-left: 227px">Phone</span> 
                 <input class="form-control" placeholder="ENTER PHONE" name="phone" type="text" required  />
              </div>

               <div class="form-group">
                 <span style="padding-left: 227px">Email</span> 
         ...
         <button class="btn btn-primary pull-right" type="submit" style="margin-right: 255px;margin-top: 20px">Add Student</button>
