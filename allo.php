...
require 'connect.php';
        ...
        $querer = "SELECT * FROM allocate";
        $query_runner = mysql_query($querer);

      

if (isset($_POST['course']) && isset($_POST['duration'])) {
  if (isset($_POST['time'])  && isset($_POST['range']))  {
       ...
       $query = "SELECT location,size FROM venue WHERE size = $range";
 ...
 $query = "INSERT INTO allocate(course,duration,timer,seat,location,size) VALUES('$course','$duration','$time','$range','$location','$size')";
...
<h5 style="text-align: center;color:red;font-weight: lighter;">SELECT TO ORDER BY YOUR CHOICE</h5>
            <form method="POST" action="allo.php">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-6">
              <div class="form-group">
                 <span>COURSE</span> 
                 <input class="form-control" placeholder="ENTER COURSE" name="course" type="text" required  />
              </div>
      </div>
      <div class="col-md-6">
               <div class="form-group">
                 <span >DURATION</span> 
                 <input class="form-control" placeholder="ENTER EXAM DURATION" name="duration" type="text" required  />
              </div>
      </div>
    </div>
      ...
      <div class="col-md-6">
              <div class="form-group">
                 <span>TIME</span> 
                 <input class="form-control" placeholder="ENTER TIME" name="time" type="text" required  />
              </div>
      </div>
      <div class="col-md-6">
               <div class="form-group">
                <span>MAXIMUM STUDENTS IN A HALL</span> 
  ...
  <button class="btn btn-primary pull-right" type="submit" style="margin-top:20px;margin-bottom:20px">Allocate</button>
            </form>
                    <thead>
                      <tr>
                        <th>Course</th>
                    ...
                    <?php while($row = mysql_fetch_array($query_runner)):;?>
                    <tbody>
                      <tr>
