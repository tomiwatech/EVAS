...
if (isset($_POST['arrange'])) {
    ...
    $query = "SELECT * FROM students ORDER BY $arrange";
    $query_run = mysql_query($query);
}
...
<h5 style="text-align: center;color:red;font-weight: lighter;">SELECT TO ORDER BY YOUR CHOICE</h5>
            <form method="POST" action="arrange.php">
                    <select class="form-control" name="arrange" required>
                      <option></option>
  ...
  <button class="btn btn-primary pull-right" type="submit" style="margin-top:20px;margin-bottom:20px">Arrange</button>
  </form>
                    <thead>
                      <tr>
                        <th>Class</th>
